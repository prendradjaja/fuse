...
Branch `constraints-1--parent-reference`, [arch doc](./JOURNAL.md.d/constraints-architecture-1)

## 4/23

Removed the circular dependency.

Branch `constraints-2--no-circular-dep`, [arch doc](./JOURNAL.md.d/constraints-2)
